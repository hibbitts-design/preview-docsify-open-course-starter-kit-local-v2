> [!NOTE]
> This is a preview repository for upcoming changes or additional examples before they're merged into the main project. View the release version at [docsify-open-course-starter-kit-local](https://github.com/hibbitts-design/docsify-open-course-starter-kit-local).
